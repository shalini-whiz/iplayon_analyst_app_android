...
public class ViewShotAdapter extends BaseAdapter {
	...
	public ViewShotAdapter(Context lContext, List<Shot> lMessageList, Map<String, String> serviceMap, Map<String, String> strokeMap, Map<String, String> destinationMap) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Shot lMessageObj = mShotList.get(position);
		...
		else if(lMessageObj.getPlayerName().equalsIgnoreCase(lMessageObj.getPlayer1Namex()))
		{
			shotHand.setTextColor(ContextCompat.getColor(mContext, R.color.playerColor));
			shotDestination.setTextColor(ContextCompat.getColor(mContext, R.color.playerColor));
			customShotLayout.setBackgroundColor(ContextCompat.getColor(mContext, R.color.lighterevenblue));
