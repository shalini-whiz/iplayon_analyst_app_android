...
public class ServiceLossAdapter extends BaseAdapter implements ListAdapter {
		...
		public ServiceLossAdapter(Context lContext, Activity lActivity, JSONArray jsonArray, Map<String, String> lServiceKeyMap, Map<String, String> lDestinationKeyMap) {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if(convertView == null)
			{
				...
				convertView = lInflater.inflate(R.layout.serviceloss_analytics,null);
			}
