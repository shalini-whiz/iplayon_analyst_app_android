...
import in.iplayon.analyst.modal.Tournament;
...
public class Util {
	...
	public void viewEvents(Context mContext,Activity mActivity,String result)
	{
	...
	public String formatDate(String inputDate){
		...
		String[] separated = inputDate.split(" ");
		if(separated[2] != null && separated[1] != null && separated[0] != null)
