...
public class SessionManager {
	...
	private String mUserSport = "mUserSport";
	...
	public void ypStoreSessionUserSport(String lUserID) {
		Editor lEditor = mSharedPref.edit();
		lEditor.putString(mUserSport, lUserID);
		lEditor.commit();
	}

	public String ypGetUserSport() {
		return mSharedPref.getString(mUserSport, null);
	}
